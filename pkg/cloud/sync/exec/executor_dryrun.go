...
func NewDryRunExecutor(pending []Action, opts ...ExecutorOption) *DryRunExecutor {
	ret := &DryRunExecutor{
		pending: pending,
	}
...
func (ex *DryRunExecutor) String() string { return ex.buf.String() }

func (ex *DryRunExecutor) Run(ctx context.Context, c cloud.Cloud) ([]Action, error) {
...
func (ex *DryRunExecutor) runEventOnly(ctx context.Context, c cloud.Cloud) {
...
func (ex *DryRunExecutor) runAction(ctx context.Context, c cloud.Cloud, a Action) {
...
func (ex *DryRunExecutor) next() Action {
...
func (ex *DryRunExecutor) signal(ev Event) []TraceSignal {
	var ret []TraceSignal
	for _, a := range ex.pending {
		if a.Signal(ev) {
