...
// Workflow will perform updates to cloud resources wanted in graph.
func Workflow(ctx context.Context, c cloud.Cloud, graph *sync.Graph) error {
	w := workflow{
		cloud: c,
		got:   sync.NewGraph(),
		want:  graph,
...
func (w *workflow) plan(ctx context.Context) error {
...
func (w *workflow) propagateRecreates() error {
...
func (w *workflow) sanityCheck() error {
